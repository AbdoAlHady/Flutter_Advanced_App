...
class TextStyles {
  ...
  static TextStyle font18BlackBold=  TextStyle(fontSize: 18.sp,fontWeight: FontWeightHelper.bold,color:ColorsManager.darkBlue);
  ...
  static TextStyle font13BlueDarkRegular=  TextStyle(fontSize: 13.sp,fontWeight: FontWeightHelper.regular,color: ColorsManager.darkBlue);
  static TextStyle font15WhiteMeduim=  TextStyle(fontSize: 15.sp,fontWeight: FontWeightHelper.meduim,color: Colors.white);
  static TextStyle font15WhiteSemiBold=  TextStyle(fontSize: 15.sp,fontWeight: FontWeightHelper.semiBold,color: Colors.white);
